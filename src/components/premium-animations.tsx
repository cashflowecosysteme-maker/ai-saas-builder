    ...
    >
      <style jsx>{`
        @keyframes glow-pulse {
          0%, 100% {
            filter: drop-shadow(0 0 5px ${colors[color]}) drop-shadow(0 0 10px ${colors[color]});
          }
          50% {
            filter: drop-shadow(0 0 20px ${colors[color]}) drop-shadow(0 0 40px ${colors[color]});
          }
        }
      `}</style>
      {children}
  ...
  return (
    <div className={`relative ${className}`}>
      <div
        ...
        style={{
          background: "linear-gradient(90deg, #a855f7, #3b82f6, #22c55e, #f59e0b, #a855f7)",
